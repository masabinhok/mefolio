  ...
  return (
    <section className="section">
      <div className="flex justify-between mb-3 gap-10 max-md:gap-3 ">
        <div className="">
          <h2 className="text-xl font-bold max-md:text-base">hey_<span className="text-primary">{visitor}</span> meet me, <span className="text-primary">I am Sabin Shrestha</span></h2>
        </div>
